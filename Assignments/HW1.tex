...
\title{DSC291 Stochastic Optimization}
...
\textbf{Critical batch size:} Beyond some $b$ (e.g.\ around 20--100 on the diabetes dataset), increasing batch size gives diminishing returns; final loss saturates.
